  ...
  const handleAnalyze = async () => {
    ...
    try {
      const response = await fetch(
        "https://pdpavan.app.n8n.cloud/webhook/b1c288d0-7318-45c5-aeda-53d986b726df",
        {
          method: "POST",
      ...
      const output: WebhookOutput | undefined = Array.isArray(data)
        ? data[0]?.output
        : data.output;
